 ...
 */
class OphCiAmdassessment_rfrf extends BaseEventTypeElement
{
	/**
	...
	{
		return 'et_ophciamdassessment_rf_rf';
	}
...
//			'complication' => array(self::HAS_ONE, 'CataractComplications', 'complication_id'),
	...
	public function getName() {
		return OphCiAmdassessment_rfrfOption::model()->findByPk($this->rf_option_id)->name;
	}

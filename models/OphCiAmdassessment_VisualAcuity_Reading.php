...
/**
 * This is the model class for table "ophciamdassessment_visualacuity_reading".
 *
 * @property integer $id
 ...
 */
class OphCiAmdassessment_VisualAcuity_Reading extends BaseActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return OphCiAmdassessment_VisualAcuity_Reading the static model class
	 */
	...
	{
		return 'ophciamdassessment_visualacuity_reading';
	}
	...
	{
		return array(
				'element' => array(self::BELONGS_TO, 'Element_OphCiAmdassessment_VisualAcuity', 'element_id'),
				'method' => array(self::BELONGS_TO, 'OphCiAmdassessment_VisualAcuity_Method', 'method_id'),
		);
	}
	 ...
	 * @param integer $base_value
	 * @param integer $unit_id
	 * @return OphCiAmdassessment_VisualAcuityUnitValue
	 */
	public function getClosest($base_value, $unit_id = null)
	{
		...
		$value = OphCiAmdassessment_VisualAcuityUnitValue::model()->find($criteria);
		return $value;
	}

 ...
 */
class OphCiAmdassessment_ofof extends BaseEventTypeElement
{
	/**
	...
	{
		return 'et_ophciamdassessment_of_of';
	}
...
//			'complication' => array(self::HAS_ONE, 'CataractComplications', 'complication_id'),
	...
	public function getName() {
		return OphCiAmdassessment_ofofOption::model()->findByPk($this->of_option_id)->name;
	}

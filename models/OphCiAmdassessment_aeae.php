 ...
 */
class OphCiAmdassessment_aeae extends BaseEventTypeElement
{
	/**
	...
	{
		return 'et_ophciamdassessment_ae_ae';
	}
...
//			'complication' => array(self::HAS_ONE, 'CataractComplications', 'complication_id'),
	...
	public function getName() {
		...
		return OphCiAmdassessment_aeaeOption::model()->findByPk($this->ae_option_id)->name;
	}

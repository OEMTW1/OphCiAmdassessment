 ...
 */
class OphCiAmdassessment_cfcf extends BaseEventTypeElement
{
	/**
	...
	{
		return 'et_ophciamdassessment_cf_cf';
	}
...
//			'complication' => array(self::HAS_ONE, 'CataractComplications', 'complication_id'),
	...
	public function getName() {
		return OphCiAmdassessment_cfcfOption::model()->findByPk($this->cf_option_id)->name;
	}

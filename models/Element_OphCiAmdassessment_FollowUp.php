 ...
 */
class Element_OphCiAmdassessment_FollowUp extends BaseEventTypeElement
{
	public $service;
	...
	{
		return 'et_ophciamdassessment_followup';
	}
	...
	public function rules()
	{
		...
		return array(
			array('event_id, followup_comment', 'safe'),
			array('followup_comment', 'required'), // EJM (12/06/2013)
...
//			array('injection_drug_left', 'required'),
			...
			array('id, event_id,followup_comment', 'safe', 'on' => 'search'),
		);
	}
	...
	public function getFollowUp_option_list() {

		return CHtml::listData(Yii::app()->db->createCommand()
			->select('et_ophciamdassessment_followup_followup_options.id, et_ophciamdassessment_followup_followup_options.name')
			->from('et_ophciamdassessment_followup_followup_options')
			->queryAll(), 'id', 'name');
